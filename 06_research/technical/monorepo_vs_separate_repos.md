...
- [[02_projects/kulitku/00_project_hub|Kulitku]] — backend + frontend + mobile + scraper
- [[02_projects/budgetnest/00_project_hub|BudgetNest]] — backend + frontend + mobile
- [[02_projects/kontrakan-id/00_project_hub|Kostify]] — backend + web + mobile (pnpm workspace)
